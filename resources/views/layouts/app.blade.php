    ...
    <body class="font-sans bg-gray-background antialiased text-gray-900 text-sm">
        <header class="flex items-center justify-between px-8 py-4">
            ...
            <div class="flex items-center">
                ...
                @endif
                <a href="#">
                    <img src="https://www.gravatar.com/avatar/000000000000000000000000000000?d=mp&f=y" alt="avatar" class="w-10 h-10 rounded-full">
                </a>
            </div>
        </header>
        ...
        <main class="container mx-auto max-w-custom flex" style="max-width:1000px">
            <div class="mr-5 w-70">
                ...
                <div class="text-center px-6 py-2 pt-6">
                    ...
                    <form action="#" method="POST" class="space-y-4 px-4 py-6">
                        <div>
                            <input type="text" name="" id="" class="w-full text-sm bg-gray-100 border-none rounded-xl placeholder-gray-900 px-4 py-2" placeholder="Your idea">
                        </div>
                        <div>
                        ...
                        <div class="flex items-center justify-between space-x-3">
                            <button type="button" class="flex items-center justify-center w-1/2 h-11 text-xs bg-gray-200 font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-6 text-gray-600">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M18.375 12.739l-7.693 7.693a4.5 4.5 0 01-6.364-6.364l10.94-10.94A3 3 0 1119.5 7.372L8.552 18.32m.009-.01l-.01.01m5.699-9.941l-7.81 7.81a1.5 1.5 0 002.112 2.13" />
                                </svg>
                                <span class="ml-1">Attach</span>
                            </button>
                            <button type="submit" class="flex items-center text-white justify-center w-1/2 h-11 text-xs bg-blue font-semibold rounded-xl border border-blue hover:blue-hover transition duration-150 ease-in px-6 py-3">
            ...
            <div class="w-24">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. A at dicta enim ex, excepturi fuga iste iure minima molestiae officiis optio, pariatur placeat quidem, repudiandae saepe sapiente sequi tempora voluptatum?
            </div>
        </main>
    </body>
</html>
